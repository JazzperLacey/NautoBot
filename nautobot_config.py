...
DATABASES = {
    "default": {
        ...
        "PASSWORD": os.getenv("NAUTOBOT_DB_PASSWORD", "abcde12345"),  # Database password
...
SECRET_KEY = os.getenv("NAUTOBOT_SECRET_KEY", "7$d)oq@sep$!ln_2pblry2np_(u+yedh(uv^ygfzyh)&x=-$6z")
